...
- Generating waves of moves in Python with numpy
- Sending commands to the machine
- Synchronizing machine, server and app state through Redis and websockets
- Exposing API for the app
- Processing messages from the machine

## Architecture

This is just server code, it needs other modules to function:
